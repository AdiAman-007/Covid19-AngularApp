...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _amcharts_amcharts4_maps__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @amcharts/amcharts4/maps */
    "./node_modules/@amcharts/amcharts4/maps.js");
    /* harmony import */


    var _amcharts_amcharts4_geodata_india2019High__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @amcharts/amcharts4-geodata/india2019High */
    "./node_modules/@amcharts/amcharts4-geodata/india2019High.js");
    /* harmony import */
    ...
    var _filter_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./filter.pipe */
    ...
    function AppComponent_p_70_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function AppComponent_h4_80_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_h4_81_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_p_86_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function AppComponent_p_88_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function AppComponent_p_90_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function AppComponent_p_92_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function AppComponent_div_95_ng_template_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_95_div_5_ngb_accordion_1_ng_template_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_95_div_5_ngb_accordion_1_ng_template_3_Template_button_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

          var data_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).$implicit;

          var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r19.zoomState(data_r15.statecode, data_r15.state);
        });
    ...
    function AppComponent_div_95_div_5_ngb_accordion_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_95_div_5_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_95_div_9_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_div_95_div_9_div_1_Template_div_click_1_listener() {
          ...
          return ctx_r25.setTablePage(page_r24);
        });
    ...
    function AppComponent_div_95_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_div_95_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_div_95_Template_input_ngModelChange_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r28);

          var ctx_r27 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r27.searchText = $event;
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(appService, zone) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function fetchData() {
          ...
          this.appService.getSummary().subscribe(function (res) {
            _this.prevDayData = JSON.parse(JSON.stringify(res.cases_time_series[res.cases_time_series.length - 1]));
            _this.summaryData = JSON.parse(JSON.stringify(res.statewise[0]));
            _this.prevDayData.totalActive = (Number(_this.summaryData.confirmed) - (Number(_this.summaryData.recovered) + Number(_this.summaryData.deaths))).toString();
            _this.prevDayData.dailyActive = (Number(_this.prevDayData.dailyconfirmed) - (Number(_this.prevDayData.dailyrecovered) + Number(_this.prevDayData.dailydeceased))).toString();
            _this.stateData = JSON.parse(JSON.stringify(res.statewise));
            _this.timeSeriesData = JSON.parse(JSON.stringify(res.cases_time_series));
            _this.testedSummary = res.tested[res.tested.length - 1];
          });
        }
      }, {
        key: "composeChartData",
        value: function composeChartData() {
          this.chartTotalConfirmedWeekly = [];
          this.chartDailyConfirmed = [];
          this.chartTotalActiveWeekly = [];
          this.chartDailyActive = [];
          ...
          if (this.blue) {
            for (var weekCount = this.timeSeriesData.length; weekCount >= 1; weekCount--) {
            ...
            for (var i = 0; i < this.stateData.length; i++) {
              if (this.stateData[i]['statecode'] != "LA") {
                this.mapDataConfirmed.push({
                  id: "IN-" + this.stateData[i]['statecode'],
                  value: Number(this.stateData[i]['confirmed'])
                });
              } else {
                this.mapDataConfirmed.push({
                  id: "IN-LK",
            ...
            for (var _weekCount = this.timeSeriesData.length; _weekCount >= 1; _weekCount--) {
              this.chartTotalActiveWeekly.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].totalconfirmed - (Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].totalrecovered) + Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].totaldeceased))),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount]['date'].slice(0, 6)
              });
              this.chartDailyActive.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].dailyconfirmed - (Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].dailyrecovered) + Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount].dailydeceased))),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount]['date'].slice(0, 6)
              });
            }

            for (var _i = 0; _i < this.stateData.length; _i++) {
              if (this.stateData[_i]['statecode'] != "LA") {
                this.mapDataActive.push({
                  id: "IN-" + this.stateData[_i]['statecode'],
                  value: Number(this.stateData[_i]['active'])
                });
              } else {
                this.mapDataActive.push({
                  id: "IN-LK",
            ...
            for (var _weekCount2 = this.timeSeriesData.length; _weekCount2 >= 1; _weekCount2--) {
              this.chartTotalRecoveredWeekly.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount2].totalrecovered),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount2]['date'].slice(0, 6)
              });
              this.chartDailyRecovered.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount2].dailyrecovered),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount2]['date'].slice(0, 6)
              });
            }

            for (var _i2 = 0; _i2 < this.stateData.length; _i2++) {
              if (this.stateData[_i2]['statecode'] != "LA") {
                this.mapDataRecovered.push({
                  id: "IN-" + this.stateData[_i2]['statecode'],
                  value: Number(this.stateData[_i2]['recovered'])
                });
              } else {
                this.mapDataRecovered.push({
                  id: "IN-LK",
            ...
            for (var _weekCount3 = this.timeSeriesData.length; _weekCount3 >= 1; _weekCount3--) {
              this.chartTotalDeathsWeekly.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount3].totaldeceased),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount3]['date'].slice(0, 6)
              });
              this.chartDailyDeaths.push({
                "value": Number(this.timeSeriesData[this.timeSeriesData.length - _weekCount3].dailydeceased),
                "date": this.timeSeriesData[this.timeSeriesData.length - _weekCount3]['date'].slice(0, 6)
              });
            }

            for (var _i3 = 0; _i3 < this.stateData.length; _i3++) {
              if (this.stateData[_i3]['statecode'] != "LA") {
                this.mapDataDeaths.push({
                  id: "IN-" + this.stateData[_i3]['statecode'],
                  value: Number(this.stateData[_i3]['deaths'])
                });
              } else {
                this.mapDataDeaths.push({
                  id: "IN-LK",
        ...
        key: "fetchDistrictData",
        value: function fetchDistrictData() {
          this.appService.getDistrictData().subscribe(function (res) {
            console.log(res);
          });
        }
      }, {
        key: "drawTrendChart1",
        value: function drawTrendChart1(data) {
          this.trendChart1.data = data;

          if (this.blue) {
            this.trendChart1.colors.list = [_amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["color"]("#5B86E5")];
          } else if (this.red) {
            this.trendChart1.colors.list = [_amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["color"]("#dc3545")];
          } else if (this.green) {
            this.trendChart1.colors.list = [_amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["color"]("#1D976C")];
          } else if (this.black) {
            this.trendChart1.colors.list = [_amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["color"]("#757575")];
          }
          ...
          var series = this.trendChart1.series.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_2__["ColumnSeries"]());
        ...
        value: function drawMap() {
          ...
          this.polygonSeries.useGeodata = true; // Configure series tooltip
          ...
          polygonTemplate.events.on("hit", function (ev) {
            ...
            if (_this2.statePolygon) {
              _this2.statePolygon.isActive = false;
            }

            ev.target.series.chart.zoomToMapObject(ev.target);

            if (_this2.statePolygon !== ev.target) {
              _this2.statePolygon = ev.target;
            }

            var stateSelected = ev.target.dataItem.dataContext.name.toString();
            _this2.stateSelected = stateSelected;
            _this2.searchText = _this2.stateSelected;
          ...
          var homeButton = this.chartMap.chartContainer.createChild(_amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_1__["Button"]);
          homeButton.events.on("hit", function () {
            _this2.stateSelected = "";
            _this2.searchText = "";

            _this2.chartMap.goHome();
            ...
            _this2.chartMap.homeZoomLevel = 0;
            _this2.chartMap.homeGeoPoint = {
              longitude: 82.80069999999999,
              latitude: 22.41940558442722
            };
          });
        ...
        key: "selectMap",
        value: function selectMap(color) {
        ...
        key: "zoomState",
        value: function zoomState(statecode, stateName) {
          if (stateName != "Total" && stateName != "State Unassigned") {
            ...
            this.statePolygon.isActive = true; // this.showTable = false;
          }
        }
      }, {
        key: "setTablePage",
        value: function setTablePage(page) {
          this.pageNmbr = page;
        }
      }]);
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_app_service__WEBPACK_IMPORTED_MODULE_6__["AppService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_91_listener() {
            return ctx.selectMap("green");
          });
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["UpperCasePipe"], _filter_pipe__WEBPACK_IMPORTED_MODULE_10__["PaginatePipe"], _filter_pipe__WEBPACK_IMPORTED_MODULE_10__["FilterPipe"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _filter_pipe__WEBPACK_IMPORTED_MODULE_6__["FilterPipe"], _filter_pipe__WEBPACK_IMPORTED_MODULE_6__["PaginatePipe"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppFilterPipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PaginatePipe = /*#__PURE__*/function () {
      ...
      _createClass(PaginatePipe, [{
        key: "transform",
        value: function transform(items, page) {
          var data = items;
          var filterList = [];

          if (page == 0 && data) {
            for (var i = page; i < page + 13; i++) {
              filterList.push(data[i]);
            }

            return filterList;
          } else if (data) {
            for (var _i4 = page * 10 + 2; _i4 < page * 10 + 13; _i4++) {
              if (data[_i4]) {
                filterList.push(data[_i4]);
              }
            }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\adiam\Documents\GitHub\Covid19-AngularApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
